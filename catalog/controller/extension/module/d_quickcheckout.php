 ...
 *
 * @uses ControllerExtensionModuleQuickcheckout:validate() 
 * @uses ControllerExtensionModuleQuickcheckout:load_settings()
 * @uses ControllerExtensionModuleQuickcheckout:get_login_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_payment_address_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_shipping_address_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_shipping_method_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_payment_method_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_cart_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_payment_view()
 * @uses ControllerExtensionModuleQuickcheckout:get_confirm_view()
 */
	...
	public function index(){
		...
		if($this->validate()) {		
			...
			if($this->settings['general']['enable']){
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/exntension/module/d_quickcheckout.tpl')) {
					$this->template = $this->config->get('config_template') . '/template/extension/module/d_quickcheckout.tpl';
				} else {
					$this->template = 'default/template/extension/module/d_quickcheckout.tpl';
				}
 ...
 * 
 * @uses ControllerExtensionModuleDQuickcheckout:get_settings()
 * @uses ControllerExtensionModuleDQuickcheckout:get_shipping_methods()
 * @uses ControllerExtensionModuleDQuickcheckout:get_shipping_methods()
 * 
 * @return void
 */
	private function load_settings(){
		...
		$this->language->load('extension/module/d_quickcheckout');
 ...
 */	
	private function get_social_login_providers(){
			  ...
			  $this->load->language('extension/module/d_social_login');
