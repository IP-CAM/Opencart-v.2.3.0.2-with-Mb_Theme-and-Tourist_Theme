...
<div class="row">
  ...
  <div class="product-layout col-lg-3 col-md-3 col-sm-6 col-xs-12">
     ...
     <div class="product-thumb transition">
                ...
                <div class="button-container"><div class="button-quick-view"> <a class="quick-view" href="<?php echo $product['href']; ?>" rel="" title="Quick view"> <i class="icon-eye-open"></i> <span class="wrap_text">Xem chi tiết</span> </a></div></div>
                </div>
                <div class="caption">
