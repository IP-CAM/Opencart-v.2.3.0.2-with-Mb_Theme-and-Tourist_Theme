<!-- Quick Checkout v5.0.0 by Dreamvention.com extension/module/d_quickcheckout.tpl -->
<style>
...
function refreshStep(step_number, func){
	...
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/refresh_step'+step_number,
		type: 'post',
...
function refreshStepView(step_number, func){
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/refresh_step_view'+step_number,
		type: 'post',
		data: $('#quickcheckout input[type=\'text\'], #quickcheckout input[type=\'password\'], #quickcheckout input[type=\'checkbox\'], #quickcheckout input[type=\'radio\']:checked, #quickcheckout select, #quickcheckout textarea'),
		dataType: 'html',
		beforeSend: function() {
...
function updateSettings(func){
	...
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/update_settings',
		type: 'post',
...
function refreshAllSteps(func){
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/refresh',
		type: 'post',
		data: $('#quickcheckout input[type=\'text\'], #quickcheckout input[type=\'password\'], #quickcheckout input[type=\'checkbox\']:checked, #quickcheckout input[type=\'radio\']:checked, #quickcheckout select,  #quickcheckout textarea'),
		dataType: 'html',
		beforeSend: function() {
...
$(document).on('click', '#button_login', function() {
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/login_validate',
		type: 'post',
...
function validateAllFields(func){
	...
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/validate_all_fields',
		type: 'post',
...
function validateField(fieldId, func){
	...
	if($('#'+fieldId).attr('data-require') == 'require'){
		$.ajax({
			url: 'index.php?route=extension/module/d_quickcheckout/validate_field',
			type: 'post',
...
function confirmOrderQC(func){
	...
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/confirm_order',
		type: 'post',
...
$(document).on('click', '#quickcheckout #confirm_coupon', function(event){	
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/validate_coupon',
		type: 'post',
...
$(document).on('click', '#quickcheckout #confirm_voucher', function(event){	
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/validate_voucher',
		type: 'post',
...
$(document).on('click', '#quickcheckout #confirm_reward', function(event){	
	$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/validate_reward',
		type: 'post',
...
function debug_update(){
	<?php if($settings['general']['debug']){?>	
		...
		$.ajax({
		url: 'index.php?route=extension/module/d_quickcheckout/debug',
		type: 'post',
		data: $('#quickcheckout input[type=\'text\'], #quickcheckout input[type=\'password\'], #quickcheckout input[type=\'checkbox\']:checked, #quickcheckout input[type=\'radio\']:checked, #quickcheckout select,  #quickcheckout textarea'),
		dataType: 'html',
		beforeSend: function() {
