...
$_['entry_top']              = 'Cho lên trình đơn danh mục (Nếu trình đơn này sử dụng mặc định):';
$_['entry_column']           = 'Cột:';
...
// Help
$_['help_filter']            = 'Chọn mục lọc hiển thị trong danh mục này, Để lọc được trước đó bạn phải đặt giá trị lọc cho sản phẩm. Nhập mục lọc vào khung sẽ được gợi ý';
...
$_['error_meta_title']       = 'Từ khóa tóm tắt ít nhất từ 3 đến 32 ký tự';
$_['error_keyword']          = 'Từ khóa SEO đã sớm được sử dụng';
?>