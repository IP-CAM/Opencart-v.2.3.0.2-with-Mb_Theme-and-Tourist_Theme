...
$_['text_list']                        = 'Danh mục tên cửa hàng';

// Column
$_['column_name']               = 'Tên cửa hàng';
$_['column_url']	        	= 'Địa chỉ WebSite cửa hàng';
$_['column_action']             = 'Thao tác';

// Entry
$_['entry_url']                 = 'URL Gian hàng:<br /><span class="help">Bao gồm URL đầy đủ cửa hàng của bạn. Hãy chắc chắn đã thêm vào \'/\' ở cuối. Ví dụ: http://www.yourdomain.com/path/<br /><br />Không sử dụng thư mục để tạo ra một Shop mới. Bạn nên luôn luôn điểm khác miền phụ tên miền để lưu trữ của bạn.</span>';
...
$_['entry_owner']               = 'Tên Chủ cửa hàng:';
