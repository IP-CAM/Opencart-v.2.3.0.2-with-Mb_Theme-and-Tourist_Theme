  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      ...
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="<?php echo $store['href']; ?>" target="_blank"><?php echo $text_homepage; ?></a></li>

        <li><a href="<?php echo $store['href']; ?>" target="_blank"><?php echo $text_documentation; ?></a></li>

        <li><a href="<?php echo $store['href']; ?>" target="_blank"><?php echo $text_support; ?></a></li>
