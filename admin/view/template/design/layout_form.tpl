          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <!--///////////////////////////////////////////////-->
                ...
                <table id="module-content-slide" class="table table-striped table-bordered table-hover">

                  <thead>

                    <tr>

                      <td class="text-center"><?php echo $text_content_slide; ?></td>
                  ...
                  <tbody>
                    ...
                    <?php if ($layout_module['position'] == 'content_slide') { ?>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            ...
                            <button type="button" onclick="addModule('content-slide');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
              ...
              <div class="row">
              <div class="col-lg-6 col-md-4 col-sm-12">
                <table id="module-content-left" class="table table-striped table-bordered table-hover">

                  <thead>

                    <tr>

                      <td class="text-center"><?php echo $text_content_left; ?></td>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            ...
                            <button type="button" onclick="addModule('content-left');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
              ...
              <!--///////////////////////////////////////////////-->
              <div class="col-lg-6 col-md-4 col-sm-12">
                <table id="module-content-right" class="table table-striped table-bordered table-hover">

                  <thead>

                    <tr>

                      <td class="text-center"><?php echo $text_content_right; ?></td>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            ...
                            <button type="button" onclick="addModule('content-right');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-slide').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-slide').trigger('change');
